...
return [
    ...
    'chips' => [
        ...
        'compare' => 'השוואה למוצר הקודם',
        'ask' => 'שאלה על העמוד',
        'chat' => 'השיחה עם העוזר',
        'contact' => 'פנייה לצוות',
        'callback' => 'השארת פרטים לתשובה',
        'position' => 'למה הדגם הזה',
...
:url',
        ...
        'lead_ask_field' => 'מה :field שלכם?',
        'lead_next' => 'הבא',
        'lead_finish' => 'שליחה',
        'lead_no' => 'לא תודה, רק רציתי לשאול',
        'lead_declined' => 'בסדר גמור. אפשר להמשיך לשאול אותי כל דבר.',
        'lead_consent_ask' => 'עוד דבר אחד לפני שנשמור:',
        'lead_thanks' => 'תודה! נחזור אליכם.',
        'lead_error' => 'משהו לא עבד. אפשר לנסות שוב.',
        'lead_error_not_a_phone' => 'זה לא נראה כמו מספר טלפון. אפשר לנסות שוב?',
        'lead_error_not_a_email' => 'זה לא נראה כמו כתובת מייל. אפשר לנסות שוב?',
        'lead_error_required' => 'צריך למלא את זה כדי להמשיך.',
        'lead_error_too_long' => 'קצת ארוך מדי. אפשר לקצר?',
        'lead_error_no_links' => 'בלי קישורים כאן, בבקשה.',
        'chat_earlier_one' => 'הצג הודעה קודמת',
        'chat_earlier' => 'הצג :n הודעות קודמות',
