...
return [
    ...
    'failures' => [
        ...
        'http_error' => 'האתר החזיר שגיאה (HTTP :status).',
        'unexpected_response' => 'האתר ענה, אבל לא כמו תוסף Rega (HTTP :status). ייתכן שתוסף אבטחה או מטמון משנה את התשובה.',
        'unreachable' => 'אי אפשר להתחבר לאתר. בדקו את הכתובת ושהאתר זמין.',
    ],
];
