...
- Useful, in this order: what else is needed or recommended with it (screws, oil, spacing, tools), where it fits and where it does not (indoors, outdoors, load), how to install, use or care for it, what is included, how many are needed (per square meter, per pack).
- Not useful: praise and looks ("luxurious", "professional finish", "impressive") unless the text says nothing practical; how the price is shown; delivery and pickup.
